...
class LabServiceTest {
    ...
    private fun grantAccess() {
        every { communities.findBySlug("team") } returns
            Community(id = communityId, name = "Team", slug = "team")
...
Before implementing, confirm the `Community` constructor signature used above matches
`core/src/main/kotlin/org/unividuell/countdown/core/community/Community.kt` (read it; adjust the
named arguments in the test if the aggregate requires more non-defaulted fields).
